...
<div class="card shadow mb-4">
    <div class="row">
        <div class="col-md-12">
           @include('customer.layouts.notification')
        </div>
    </div>
   <div class="card-header py-3">
     <h4 class=" font-weight-bold">Profile</h4>
     <ul class="breadcrumbs">
         <li><a href="{{route('customer.dashboard')}}" style="color:#999">Dashboard</a></li>
   ...
   <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('customer-profile-update',$profile->id)}}">
                    @csrf
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" readonly name="role" value="{{$profile->role}}" class="form-control">
                        @error('role')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                        </div>
