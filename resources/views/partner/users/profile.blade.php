...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('partner.dashboard')}}" style="color:#999">Dashboard</a></li>
   ...
   <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('partner-profile-update',$profile->id)}}">
                    @csrf
